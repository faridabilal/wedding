...
$(document).ready(function() {
    ...
    function updateCountdown() {
        ...
        // Update the display with properly formatted numbers
        ...
        if (distance < 0) {
            ...
            // Optional: Update UI to show wedding has started
            $('.countdown-container').after('<p class="alert alert-info mt-3">Our wedding is happening now!</p>');
        }
    }
